...
fn bio() -> Bio {
    ...
    bio.insert(
        ...
        I believe programming is a tool that enables us to turn our ideas into reality, and I enjoy
    ...
    bio.insert(
        "# My Projects",
        "This GitHub repository is a showcase of my work, where I share
